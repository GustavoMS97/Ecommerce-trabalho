...
namespace TrabalhoEcommerce.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CPF,nome,email,senha")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CPF,nome,email,senha")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
